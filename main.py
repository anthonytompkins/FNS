...
airport_threads = [threading.Thread(name='Airport_Thread:%d' %(i), target=Airports.airport_generator, args= ( config.get('Airports', 'home_url'),
                                                                               ...
                                                                               config.get('Airports', 'cancel_rate'))) for i in range(int(config.get('Airports', 'Threads')))]
